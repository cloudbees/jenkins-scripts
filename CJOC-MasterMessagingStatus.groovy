...
Since: June 2017
Description: This script will print out all the connected masters and their instanceIDs 
followed by their maxPulls data which is the last outboxSequenceId registered by the CJOC.
Use this script to find the current status of your connected masters messaging database files
Parameters: None
