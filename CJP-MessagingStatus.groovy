...
Since: June 2017
Description: This script will print out all the inbox and outbox data from a CJE or CJOC
instance. Use this to find out what the current messaging status is.
Parameters: None
Scope: Cloudbees Jenkins Operations Center or Cloudbees Jenkins Platform
*/
